...
@layer blocks{
  ...
  /* Vitrin fotografi bir eser degil, bir mekan: kirpilarak paneli tam
     doldurur, cerceve golgesi ve ic bosluk almaz. */
  .hero-media--room{padding:0;background:var(--ink)}
  .hero-media--room img{inline-size:100%;block-size:100%;
                        max-inline-size:none;max-block-size:none;
                        object-fit:cover;object-position:50% 42%;filter:none}
