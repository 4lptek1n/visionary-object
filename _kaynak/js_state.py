...
if (nf) nf.addEventListener('submit', e => {
  ...
  /* Ayni adres ikinci kez gelirse veritabani 409 doner; ziyaretci icin bu da
     "tesekkurler" demektir, ayrim gostermeyiz. (on_conflict kullanmiyoruz:
     RLS altinda arabulucu, okuma izni olmayan anon icin calismiyor.) */
  fetch(a.URL + '/rest/v1/bulten', {
    method: 'POST',
